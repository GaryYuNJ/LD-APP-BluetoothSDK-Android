...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter implements OnClickListener {
	...
	private  Map<Integer, List<String>> blueNameMap;
	
	public MyBaseExpandableListAdapter(Context mContext, List<String> buildingNameList,Map<Integer, List<String>> blueNameMap) {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		childHolder.textView.setText(blueNameMap.get(groupPosition).get(childPosition));
		return convertView;
	}
